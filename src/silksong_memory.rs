...
declare_pointers!(PlayerDataPointers {
    ...
    has_parry: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasParry"]),
    has_thread_sphere: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasThreadSphere"]),
    has_silk_charge: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasSilkCharge"]),
    has_silk_bomb: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasSilkBomb"]),
    has_silk_boss_needle: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasSilkBossNeedle"]),
    ...
    encountered_cogwork_dancers: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "encounteredCogworkDancers"]),
    ...
    defeated_wisp_pyre_effigy: UnityPointer<3> =  UnityPointer::new("GameManager", 0, &["_instance", "playerData", "defeatedWispPyreEffigy"]),
    ...
    encountered_ant_trapper: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "encounteredAntTrapper"]),
    defeated_ant_trapper: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "defeatedAntTrapper"]),
    ...
    has_charge_slash: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasChargeSlash"]),
    ...
    has_fast_travel_teleport: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "UnlockedFastTravelTeleport"]),
    has_needolin_memory_powerup: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "hasNeedolinMemoryPowerup"]),
    completed_cog_10_abyss_battle: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "completedCog10_abyssBattle"]),
    ...
    orbs_02c: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_02c_A"]),
    orbs_03: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_03_B"]),
    orbs_06: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_06_A"]),
    orbs_11: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_11"]),
    orbs_16_b: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_16_B"]),
    orbs_16_c: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_16_C"]),
    orbs_21: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_21"]),
    orbs_18_a: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_18_A"]),
    orbs_18_b: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_18_B"]),
    orbs_18_c: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_18_C"]),
    orbs_18_d: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_18_D"]),
    orbs_18_e: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_18_E"]),
    orbs_19: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "memoryOrbs_Clover_19"]),
    ...
    defeated_roach_keeper_chef: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "defeatedRoachkeeperChef"]),
    defeated_brood_mother: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "defeatedBroodMother"]),
    ...
    collected_ward_boss_key: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "collectedWardBossKey"]),
    ward_boss_encountered: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "wardBossEncountered"]),
    ward_boss_defeated: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "wardBossDefeated"]),
    met_gourmand_servant: UnityPointer<3> = UnityPointer::new("GameManager", 0, &["_instance", "playerData", "MetGourmandServant"]),
